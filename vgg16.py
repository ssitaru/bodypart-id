...
parser = argparse.ArgumentParser(description='Train VGG16')
...
if ARGS.no_init_weights:
      ...
      w = None
MODEL.add(VGG16(include_top=False, weights=w, input_shape=(224,224,3)))
...
MODEL.save('./vgg16_{runid}_{valacc:.4f}.h5'.format(runid=ARGS.runid, valacc=valacc[len(valacc)-1]))

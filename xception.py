#!/usr/bin/python
# This script trains xception
# This is the script used for the publication
...
if ARGS.no_init_weights:
      ...
      w = None
MODEL.add(Xception(include_top=False, weights=w, input_shape=(299,299,3)))
...
MODEL.save('./xception_{runid}_{valacc:.4f}.h5'.format(runid=ARGS.runid, valacc=valacc[len(valacc)-1]))
